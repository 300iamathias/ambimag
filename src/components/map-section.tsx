      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="mt-4 text-gray-500 max-w-xl mx-auto text-base leading-relaxed">
            Estamos ubicados en el corazón de Guayaquil, Ecuador. Atendemos presencial y virtualmente a empresas de todo el país.
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 sm:gap-8">
          ...
          >
            <div className="rounded-xl overflow-hidden shadow-lg border border-gray-200 h-[350px] sm:h-[420px]">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d127560.473449!2d-79.9345!3d-2.1709!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x902d6c2829b5e1e7%3A0x5c0e6f5e1a5e5e5e!2sGuayaquil%2C%20Ecuador!5e0!3m2!1ses!2sec!4v1700000000000!5m2!1ses!2sec"
                width="100%"
                height="100%"
                style={{ border: 0 }}
                allowFullScreen
                ...
                title="Ubicación de Ambimag en Guayaquil, Ecuador"
              />
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="bg-gradient-to-br from-[#1B7340] to-[#145C33] rounded-xl p-6 text-white shadow-lg flex-1">
              ...
              <p className="text-white/80 text-sm leading-relaxed mb-4">
                Guayaquil, Provincia del Guayas<br />
                Ecuador — Sudamérica
              </p>
            ...
            <a
              href="https://www.google.com/maps/dir//-2.1709,-79.9345"
              target="_blank"
